...
3. [Download](https://slack.com/downloads) and install Slack's application. You will receive an invitation in your email to join to Slack's workspace *globant-qnr1734* or just sign in to https://globant.slack.com and join the channel #java-bootcamp-inditex-all
